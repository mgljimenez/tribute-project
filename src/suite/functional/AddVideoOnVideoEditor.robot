...
Force Tags  smoke  addVideo
Default Tags  AddVideoOnVideoEditor
...
User Has Successfully Viewed Video On Invitation Page
  ...
  When User Add Video On Video Editor
  Then User Should Successfully Uploaded Video Via Video Editor
